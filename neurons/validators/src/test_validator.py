...
if __name__ == "__main__":
    ...
    rented_machine = RentedMachine(
        miner_hotkey="miner_hotkey",
        executor_id='executor_id',
        executor_ip_address='executor_ip_address',
        executor_ip_port='2000',
        container_name='container_name',
    )
    rented_machine_str =rented_machine.model_dump_json()
    machine = RentedMachine.model_validate(json.loads(rented_machine_str))
    print(json.loads(rented_machine_str))
